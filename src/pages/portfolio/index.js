...
export const Portfolio = () => {
          ...
          return (
            <div key={i} className="po_item">
              ...
              <div className="content">
                <p>{desc}</p>
                {(data.id === "project1" || data.id === "project2" || data.id === "project3" || data.id === "project4" || data.id === "project5" || data.id === "project6" || data.id === "project7" || data.id === "project8") ? (
  ...
  return (
    <HelmetProvider>
      <Container className="About-header" style={{ paddingBottom: "60px" }}>
        <Helmet>
          <meta charSet="utf-8" />
